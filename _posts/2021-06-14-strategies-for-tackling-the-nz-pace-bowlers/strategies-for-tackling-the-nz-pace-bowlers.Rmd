...
description: |
  The fast bowler has been in red hot form in the lead up to this series. So how should India's batsmen plan to face him?
author:
...
```{r, echo=FALSE, out.width="30%", out.height="30%", fig.align='left', fig.cap="Source: @CricInsights21 on Twitter"}

knitr::include_graphics("https://pbs.twimg.com/media/E3HXX4lXMAIutvY?format=png&name=4096x4096")
